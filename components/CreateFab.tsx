    ...
    <div className="md:hidden">
      ...
      <div className="create-fab fixed bottom-24 right-4 z-50 flex flex-col items-end gap-3">
        ...
        <button
          ...
          aria-expanded={open}
          className={`w-14 h-14 rounded-full bg-teal-800 text-white shadow-lg flex items-center justify-center active:scale-90 transition-transform ${open ? 'rotate-45' : 'animate-float'}`}
        >
          <Plus size={26} />
        </button>
      </div>
