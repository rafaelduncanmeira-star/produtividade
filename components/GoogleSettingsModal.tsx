...
export const GoogleSettingsModal: React.FC<GoogleSettingsModalProps> = ({
  settings, connected, onConnect, onDisconnect, onClose,
}) => {
        ...
        <div className="p-6 space-y-4 pb-[max(1.5rem,env(safe-area-inset-bottom))]">
          {connected ? (
            <div className="flex items-center gap-3 bg-emerald-50 border border-emerald-200 rounded-xl px-4 py-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-emerald-600">Seus eventos aparecem no Planejamento e na tela Hoje.</p>
              </div>
            </div>
          ) : (
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-400 mt-1">
              Chave gratuita gerada no painel do Google Cloud (termina com <span className="font-mono">.apps.googleusercontent.com</span>).
            </p>
          </div>
